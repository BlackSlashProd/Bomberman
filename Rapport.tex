...
\newline\newline
\textbf{Cibles du fichier build.xml :}\newline
Compilation du projet : \texttt{ant compile}\newline
Lancement du jeu : \texttt{ant run}\newline
Lancement du jeu buggée : \texttt{ant runbug}\newline
Lancement des tests sur le jeu : \texttt{ant test}\newline
Lancement des tests sur le jeu buggée : \texttt{ant testbug}\newline
...
Pour des raisons de lisibilité des spécifications, nous avons préféré laisser ces dernières dans les fichiers texte séparés, dans le dossier \texttt{Spécifications} à la racine du projet.\newline\newline
