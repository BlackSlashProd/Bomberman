...
public abstract class AbstractKidnappeurTest {
	
	private KidnappeurService joueur;
	private TerrainService terrain;
	
	public AbstractKidnappeurTest(){
		this.joueur = null;
	}
	
	public KidnappeurService getJoueur() {
		return joueur;
	}

	public void setJoueur(KidnappeurService joueur) {
		this.joueur = joueur;
	}
	...
	@Test
	public void test_post_setForce_2(){
		//Init
		joueur.init(2, 2, terrain);
		// force < 3
		try{
			...
			//Verif
			assertTrue("JoueurService : setForce : post : setForce(2) leve une exception", true);
			return;
		}
		assertTrue("JoueurService : setForce : post : setForce(2) ne leve pas d'exception", false);
	}
	@Test
	public void test_post_setForce_3(){
		//Init
		joueur.init(2, 2, terrain);
		// force > 11
		try{
			...
			//Verif
			assertTrue("JoueurService : setForce : post : setForce(12) leve une exception", true);
			return;
		}
		assertTrue("JoueurService : setForce : post : setForce(12) ne leve pas d'exception", false);
	}
	/**
	 * TEST POUR SET_LIGNE
	 */
	...
	@Test
	public void test_post_setLigne_2(){
		//Init
		joueur.init(2, 2, terrain);
		// ligne < 2
		try{
			...
			//Verif
			assertTrue("JoueurService : setLigne : post : setLigne(1, t) leve une exception", true);
			return;
		}
		assertTrue("JoueurService : setLigne : post : setLigne(1, t) ne leve pas d'exception", false);
	}
	@Test
	public void test_post_setLigne_3(){
		//Init
		joueur.init(2, 2, terrain);
		// ligne > 12
		try{
			...
			//Verif
			assertTrue("JoueurService : setLigne : post : setLigne(13, t) leve une exception", true);
			return;
		}
		assertTrue("JoueurService : setLigne : post : setLigne(13, t) ne leve pas d'exception", false);
	}
	/**
	 * TEST POUR SET_COLONNE
	 */
	@Test
	...
	@Test
	public void test_post_setColonne_2(){
		//Init
		joueur.init(2, 2, terrain);
		// ligne < 2
		try{
			...
			//Verif
			assertTrue("JoueurService : setColonne : post : setColonne(1, t) leve une exception", true);
			return;
		}
		assertTrue("JoueurService : setColonne : post : setColonne(1, t) ne leve pas d'exception", false);
	}
	@Test
	public void test_post_setColonne_3(){
		//Init
		joueur.init(2, 2, terrain);
		// ligne > 12
		try{
			...
			//Verif
			assertTrue("JoueurService : setColonne : post : setColonne(15, t) leve une exception", true);
			return;
		}
		assertTrue("JoueurService : setColonne : post : setColonne(15, t) ne leve pas d'exception", false);
	}
	/**
	 * TEST POUR SET_PASSEBOMBE
	 */
	@Test
	...
	@Test
	public void test_post_setNbBombePosable_2(){
		//Init
		joueur.init(2, 2, terrain);
		// nb < 0
		try{
			...
			//Verif
			assertTrue("JoueurService : setNbBombePosable : post : setNbBombePosable(-1) leve une exception", true);
			return;
		}
		assertTrue("JoueurService : setNbBombePosable : post : setNbBombePosable(-1) ne leve pas d'exception", false);
	}
	/**
	 * TEST POUR SET_INVULNERABLE
	 */
	@Test
	...
	@Test
	public void test_post_addReward_7(){
		//Init
		joueur.init(2, 2, terrain);
		//Save
		int f = joueur.getForce();
		...
		//Verif
		assertTrue("JoueurService : addReward : post : addReward(BlocReward.Rien) ne modifie pas la force du joueur", joueur.getForce() == f);
		assertTrue("JoueurService : addReward : post : addReward(BlocReward.Rien) ne modifie pas la capacite du joueur a passer a travers les bombes", joueur.passeBombe() == b);
		assertTrue("JoueurService : addReward : post : addReward(BlocReward.Rien) ne modifie pas la capacite du joueur a passer a travers les murs", joueur.passeMuraille() == m);
		assertTrue("JoueurService : addReward : post : addReward(BlocReward.Rien) ne modifie pas la ligne du joueur", joueur.getColonne() == c);
		assertTrue("JoueurService : addReward : post : addReward(BlocReward.Rien) ne modifie pas la colonne du joueur", joueur.getLigne() == l);
		assertTrue("JoueurService : addReward : post : addReward(BlocReward.Rien) ne modifie pas le nombre de bombes posables par le joueur", joueur.getNbBombePosable() == p);
		assertTrue("JoueurService : addReward : post : addReward(BlocReward.Rien) ne modifie pas l'invulneravilite du joueur", joueur.getInvulnerableStep() == i);
	}
}
