...
public class MainBug {
	...
	public static void main(String[] args) {
		...
		m.init(500);
		IHM ihm = new IHM(m);
		JFrame fenetre = new JFrame("Monsieur Bombe - Version pleine de bugs !");
		fenetre.add(ihm);
		fenetre.setIconImage(new ImageIcon("ressources/icon_player_1_dead.png").getImage());
